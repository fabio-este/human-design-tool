...
{
    private $userId = 625924;
    private $apiKey = "c2142ace5f802d5a77cb809fa928ae18";
...
*/
    ...
    public function matchBirthDetails(array $maleBirthData, array $femaleBirthData)
    {
        ...
        $response = $this->getCurlReponse($this->userId, $this->apiKey, $resourceName, $data, $this->language);
        return $response;
    }
    ...
    /*public function getNumeroGemSuggestion($date, $month, $year, $name)
    {
        ...
        $data = $this->packageNumeroData($date, $month, $year, $name);
        $response = $this->getCurlReponse($this->userId, $this->apiKey, $resourceName, $data);
        return $response;
    }*/
    ...
    public function getWesternHoroscope($date, $month, $year, $hour, $minute, $latitude, $longitude, $timezone, $settings = array())
    {
        ...
        $response = $this->getCurlReponse($this->userId, $this->apiKey, $resourceName, $data, 'en');
        return $response;
    }
    ...
    {
        $response = $this->getCurlReponse($this->userId, $this->apiKey, $endPoint, $data, $this->language);
        return $response;
    }
