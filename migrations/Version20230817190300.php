 ...
 */
final class Version20230817190300 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE bodygraph ADD aura_type_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE bodygraph DROP aura_type_id');
    }
}
